...
Once you see how easy it is to have an impact on an OT network...

It isn't something you'll forget.
...
## 2. Use GenAI to Create Your Own OT Tools
...
## 3. Build a Virtual PLC

Understanding how the most common OT asset works is critical.
...
OT assets such as PLCs and HMIs can be exposed to the Internet.
...
Nothing beats a free lab environment that's easy to get set up.

And that looks cool at the same time!

Learn OT attacks.

Learn how to defend OT.
