# OT/ICS Cybersecurity Curriculum Resources

A curated list of resources to accompany the OT/ICS Cybersecurity curriculum.
...
- CompTIA Security+ Study Guide (Sybex) (Paid)
...
# Module 6 – Industrial Control Systems
...
# Module 7 – Industrial Networking
...
# Module 10 – Detection Engineering
...
# Module 13 – OT Security Architecture
...
# Module 14 – Governance, Risk & Compliance
...
- Practical Industrial Cybersecurity — Pascal Ackerman
...
|----------|---------|---------|
| OpenPLC | PLC Simulator | Free |
| Wireshark | Packet Analysis | Free |
| Security Onion | SOC Platform | Free |
| Zeek | Network Monitoring | Free |
| Suricata | IDS/IPS | Free |
| Snort | IDS | Free |
| Greenbone/OpenVAS | Vulnerability Scanner | Free |
| Factory I/O | Industrial Simulation | Paid |
...
- Build a home lab using OpenPLC, Wireshark, and Security Onion.
- Read NIST SP 800-82 alongside the ICS modules.
- Practice packet analysis using industrial protocols.
- Document your labs and projects in a GitHub repository.
- Contributions to improve or update these resources are welcome.
